...
22 pages cover the homepage, services, adult support, young adults, children and families, community support, consultancy, about, referrals, careers, safeguarding, contact, England-wide coverage, complaints and complaints procedure, privacy, cookies, accessibility, equality, terms, modern slavery and the custom 404 page.
...
Content is based on the supplied Dayspring Centre PRD with England-wide coverage. Childcare registration EY552018 is described separately from adult support and independent consultancy. No ratings, testimonials, staff identities, partnerships or current vacancies have been invented. Images are AI-generated illustrations and disclosed as illustrative in the footer. See `asset-notes.md`.


## Logo downloads

The website footer links to `assets/dayspring-centre-logo.zip`, containing scalable SVG and transparent PNG versions of the full logo and icon. Primary colour: #164E4A; neutral background: #FAF7F0.
